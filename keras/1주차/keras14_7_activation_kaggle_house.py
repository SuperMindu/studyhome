...
#1. 데이터
path = 'C:/study/study-home/_data/kaggle_house/'
...
model.fit(x_train, y_train, epochs=5000, batch_size=150, verbose=1, validation_split=0.15, callbacks=[es])
...
# none activation
# loss :  [763364032.0, 19859.611328125]
# RMSE :  27629.043075708258
# r2스코어 :  0.8391748903662635

# activation = 'relu'
# loss :  [1501339904.0, 27360.17578125]
# RMSE :  38747.1264709199
# r2스코어 :  0.6836985595726193
