...
x_train = np.load('d:/study_data/_save/_npy/keras47_3_rps_x_train.npy')
y_train = np.load('d:/study_data/_save/_npy/keras47_3_rps_y_train.npy')
x_test = np.load('d:/study_data/_save/_npy/keras47_3_rps_x_test.npy')
y_test = np.load('d:/study_data/_save/_npy/keras47_3_rps_y_test.npy')
...
hist = model.fit(x_train, y_train, epochs=500, batch_size=32, validation_split=0.1, callbacks=[es] ,verbose=1) # 이렇게 하려면 배치사이즈를 최대로 잡아주면 됨
...
# loss :  0.08640015870332718
# val_loss :  3.9681220054626465
# accuracy :  0.9718853235244751
# val_accuracy :  0.4554455578327179
