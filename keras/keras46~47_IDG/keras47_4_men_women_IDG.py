...
data = train_datagen.flow_from_directory('d:/study_data/_data/image/men_women/', # 폴더에서 가져와서 ImageDataGenerator
...
np.save('d:/study_data/_save/_npy/keras47_4_men_women_x_train.npy', arr=x_train) 
np.save('d:/study_data/_save/_npy/keras47_4_men_women_x_test.npy', arr=x_test) 
np.save('d:/study_data/_save/_npy/keras47_4_men_women_y_train.npy', arr=y_train) 
np.save('d:/study_data/_save/_npy/keras47_4_men_women_y_test.npy', arr=y_test) 