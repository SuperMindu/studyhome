...
input = Input(shape=(5,))
embedding1 = Embedding(input_dim=31, output_dim=10, input_length=5, name='ms1')(input)
LSTM1 = LSTM(16, activation='relu', name='ms2')(embedding1)
dense1 = Dense(8, activation='relu', name='ms3')(LSTM1)
output = Dense(1, activation='sigmoid', name='out_ms1')(dense1)
...
model.fit(pad_x, labels, epochs=40, batch_size=16, verbose=1)
