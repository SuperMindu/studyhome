...
model = Sequential()
model.add(Embedding(input_dim=31, output_dim=10, input_length=5)) # Embedding을 통과하면서 벡터화 
# model.add(LSTM(32))
...
# =================================================================
# embedding (Embedding)        (None, 5, 10) <- (14, 5, 31) 이었는데 Embedding을 통과하면서 벡터화 돼서 (14, 5, 10)으로 바뀜 310           
# _________________________________________________________________
